...
local cosmicParent_OnEvent = function(self, event, ...)
	ns.EventHandler[event](self, ...)
end cosmicParent:SetScript("OnEvent", cosmicParent_OnEvent)

function ns.EventHandler:PLAYER_LOGIN(...)
...
function ns.EventHandler:PLAYER_ENTERING_WORLD(...)
...
function ns.EventHandler:UPDATE_MACROS(...)
...
function ns.EventHandler:PARTY_MEMBERS_CHANGED(...)
	-- TODO: When a group is formed/changed, update the group data in ns.Core.PlayerGroup.
end

function ns.EventHandler:ARENA_OPPONENT_UPDATE(...)
